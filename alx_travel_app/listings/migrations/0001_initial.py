    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_info', models.ForeignKey(db_column='status_id', on_delete=django.db.models.deletion.PROTECT, related_name='bookings', to='listings.bookingstatus')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='payments', to='listings.paymentmethod')),
            ],
            options={
                'db_table': 'Payment',
            },
        ...
        migrations.AddIndex(
            model_name='listing',
            index=models.Index(fields=['price_per_night'], name='Property_price_p_7d1226_idx'),
        ),
        migrations.AddIndex(
            model_name='booking',
        ...
        migrations.AddIndex(
            model_name='booking',
            index=models.Index(fields=['start_date', 'end_date'], name='Booking_start_d_9fe810_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='payment',
            index=models.Index(fields=['payment_date'], name='Payment_payment_837676_idx'),
        ),
        migrations.AddIndex(
            model_name='payment',
            index=models.Index(fields=['payment_status'], name='Payment_payment_1cfb68_idx'),
        ),
        migrations.AddIndex(
            model_name='payment',
            index=models.Index(fields=['transaction_id'], name='Payment_transac_0072b1_idx'),
        ),
        migrations.AddIndex(
            model_name='payment',
            index=models.Index(fields=['chapa_reference'], name='Payment_chapa_r_79f61a_idx'),
        ),
        migrations.AddIndex(
            model_name='review',
            index=models.Index(fields=['property'], name='Review_propert_fc8767_idx'),
        ),
        migrations.AddIndex(
            model_name='review',
            index=models.Index(fields=['user'], name='Review_user_id_180292_idx'),
        ),
        migrations.AddIndex(
            model_name='review',
            index=models.Index(fields=['rating'], name='Review_rating_946920_idx'),
        ),
        migrations.AddConstraint(
            model_name='review',
